...
from Senti_Backend.settings import SOCIAL_AUTH_GOOGLE_OAUTH2_KEY, SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET
import jwt
import requests
...
class CustomConvertTokenView(ConvertTokenView):
    ...
    def get_and_decode_id_token(self, authorization_code):
        ...
        token_data = {
            ...
            'redirect_url': "http://localhost:8001/accounts/google/login/callback/",
